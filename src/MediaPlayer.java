...
public class MediaPlayer extends JFrame {
    public static void main(String[] args) throws IOException {
        MediaPlayer w = new MediaPlayer("Neuro Neuro Neuro Go!");
    }
